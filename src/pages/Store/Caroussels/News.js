...
const News = () => {
    ...
    let Cards = [
        <Card type="SmallCard" key="0" width="400" img={Valentine} texte="Say it with a gift from Apple."></Card>,
        <Card type="SmallCard" key="1" width="400" img={Limited} texte="Save 5% on Apple products with the new Apple Card."></Card>,
        <Card type="SmallCard" key="2" width="400" img={Airpods} texte="It's magic, remastered."></Card>,
        <Card type="SmallCard" key="3" width="400" img={iPad} texte="Deligthfully capable. Surprisingly affortable."></Card>,
        <Card type="SmallCard" key="4" width="400" img={homePods} texte="You've never heard color like this."></Card>,
        <Card type="SmallCard" key="5" width="400" img={iPhonePro} texte="Oh. So. Pro."></Card>,
        <Card type="SmallCard" key="6" width="400" img={MacPro} texte="Supercharged for pros."></Card>,
        <Card type="SmallCard" key="7" width="400" img={iPhone} texte="Your new Superpower"></Card>,
        <Card type="SmallCard" key="8" width="400" img={iPadMini} texte="Mega Power. Mini Sized"></Card>,
        <Card type="SmallCard" key="9" width="400" img={watch} texte="Full Screen ahead"></Card>,
    ]
