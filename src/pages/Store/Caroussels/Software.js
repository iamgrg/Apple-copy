...
const Software = () => {
    ...
    let Cards = [
        <Card type="SmallCard" key="0" width="480" img={Join} height="500" texte="Join a Today at Apple virtual session. "></Card>,
        <Card type="SmallCard" key="1" width="480" img={Six} height="500" texte="Six Apple services. One easy subscription. "></Card>,
        <Card type="SmallCard" key="2" width="480" img={Pay} height="500" texte="Discover all the ways to use Apple Pay. "></Card>,
        <Card type="SmallCard" key="3" width="480" img={Home} height="500" texte="See how one app can control your entire home."></Card>,
        ]
    const title = ["Do more with Apple products. ", "Here’s where the fun begins."]
