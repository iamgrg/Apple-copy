...
const StVal = () => {
    ...
    let Cards = [
        <Card type="SmallCard" key="0" width="400" img={perfect} height="500" texte="Find the perfect gift for anyone. "></Card>,                        
        <Card type="SmallCard" key="1" width="313" img={iphonePink} height="500" texte="iPhone 13 Silicone Case with MagSafe - Chalk Pink"></Card>,
        <Card type="SmallCard" key="2" width="313" img={loop} height="500" texte="45mm English Lavender Braided Solo Loop - Size 4"></Card>,
        <Card type="SmallCard" key="3" width="313" img={wallet} height="500" texte="iPhone Leather Wallet with MagSafe - Golden Brown"></Card>,
        <Card type="SmallCard" key="4" width="313" img={homePods} height="500" texte="HomePod mini - Blue"></Card>,
        <Card type="SmallCard" key="4" width="313" img={iphoneBlue} height="500" texte="iPhone 13 mini Leather Case with MagSafe - Wisteria"></Card>,
        <Card type="SmallCard" key="4" width="313" img={iphonegreen} height="500" texte="iPhone 13 Pro Max Leather Case with MagSafe - Sequoia Green"></Card>,
        <Card type="SmallCard" key="5" width="400" img={accesories} height="500" texte="Explore all accessories. "></Card>,
    ]
