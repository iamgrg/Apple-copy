...
const FirstProducts = () => {
    ...
    let Cards = [
        <Card type="SmallCard" key="0" img={Mac} width="136" height="148" texte="Mac"></Card>,
        <Card type="SmallCard" key="1" img={iPhone} width="136" height="148" texte="iPhone"></Card>,
        <Card type="SmallCard" key="2" img={iPad} width="136" height="148" texte="iPad"></Card>,
        <Card type="SmallCard" key="3" img={Watch} width="136" height="148" texte="Apple Watch"></Card>,
        <Card type="SmallCard" key="4" img={Airpods} width="136" height="148" texte="Airpods"></Card>,
        <Card type="SmallCard" key="5" img={AirTag} width="136" height="148" texte="AirTag"></Card>,
        <Card type="SmallCard" key="6" img={TV} width="136" height="148" texte="Apple TV"></Card>,
        <Card type="SmallCard" key="7" img={homePods} width="136" height="148" texte="HomePod mini"></Card>,
        <Card type="SmallCard" key="8" img={Accessories} width="136" height="148" texte="Accessories"></Card>,
        <Card type="SmallCard" key="9" img={iCard} width="136" height="148" texte="Apple Gift Card"></Card>
    ]
    console.log(Cards)
